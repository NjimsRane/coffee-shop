...
import { ContactDetail, ContactFind } from '../../pages';
...
const Contact = () => {
    ...
    return (
        <div>
                ...
                <div className='h-full '>
                    ...
                    <div className='absolute w-full top-[50%] translate-y-[-50%] flex flex-col gap-8 text-[#fff] px-8 md:flex-row md:justify-between md:px-16'>
                        ...
                        <p className='flex items-center gap-2 capitalize text-lg '>
                            <Link to='/login' className='font-bold'>home</Link>
            ...
            <div className="container flex flex-col gap-8 px-4 py-5 md:px-16 md:mx-auto">
                <div className='flex flex-col gap-6 md:px-16 md:flex-row'>
                    <ContactFind
                        img={place}
                        title='find us in'
                        subTitle='Greece'
